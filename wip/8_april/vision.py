...
class VisionAnalyzer:
    ...
    # ==========================================
    # NEW PROCESS LINE FUNCTION
    # ==========================================
    def process_line(self, bottom_roi, left_flag, right_flag):
        """Extracts valid contours based on color priority and calculates the centroid."""
